...
// Workout routes
router.post('/workouts/log', requireAnyRole(['member', 'trainer']), fitnessController.logWorkout.bind(fitnessController));
...
// Diet routes
router.post('/diet/calculate-macros', requireAnyRole(['trainer', 'member']), fitnessController.calculateMacros.bind(fitnessController));
router.post('/diet/plans', requireAnyRole(['trainer', 'gym_owner', 'branch_manager']), fitnessController.createDietPlan.bind(fitnessController));
router.get('/diet/plans/member/:memberId', authenticate, fitnessController.getMemberDietPlans.bind(fitnessController));
router.post('/diet/plans/:dietPlanId/compliance', requireAnyRole(['member', 'trainer']), fitnessController.logCompliance.bind(fitnessController));
