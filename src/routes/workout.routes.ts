...
router.post('/', requireAnyRole('trainer', 'gym_owner', 'branch_manager', 'super_admin', 'member'), workoutController.createWorkout.bind(workoutController));
...
router.put('/:id', requireAnyRole('trainer', 'gym_owner', 'branch_manager', 'super_admin', 'member'), workoutController.updateWorkout.bind(workoutController));
router.delete('/:id', requireAnyRole('trainer', 'gym_owner', 'branch_manager', 'super_admin', 'member'), workoutController.deleteWorkout.bind(workoutController));
